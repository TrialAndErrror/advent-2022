...
trait SymbolManager {
    ...
    fn process_all_instructions(&mut self, instructions: Vec<String>) {
...
#[derive(Debug)]
pub struct SymbolManager9000 {
    pub data: Vec<Vec<String>>,
}

impl SymbolManager for SymbolManager9000 {}
...
impl SymbolManager for SymbolManager9001 {
    fn process_instruction(&mut self, instruction: String) {
        let info = instruction.split(" ").collect::<Vec<&str>>();
